...
The Vellosim API uses **API Key Authentication** to secure all API endpoints. You'll need to include your API key in the Authorization header of every request.
...
Include your API key in the `X-API-Key` header in the X-API-Key header:

```bash
X-API-Key: vls_live_1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef
```
